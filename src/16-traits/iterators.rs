...
// As a point of convenience for common situations, the for construct turns some collections into iterators using the .iter() method.
...
fn main() {
    ...
    // for i in array { is compiling and working as well
    for i in array.iter() {
        println!("> {}", i);
    }
}
